				...
				<div class="container-wrapper">
					<div class="container-fluid">
						<div
							...
							<h1 class="h4 mb-0 text-gray-800">휴가일정</h1>
							<div class="">
								<ol class="breadcrumb float-sm-right">
									<li class="breadcrumb-item"><a href="#">홈</a></li>
									<li class="breadcrumb-item active">휴가일정</li>
						...
						<table class="table table-hover text-gray-900">
							...
							<tbody>
								...
								for (int i=0;i<pm.getPageSize();i++) {
									if(num<1)break;
									Requests obj=dayoffList.get(curPos++);		
								%>
								<tr onClick="getDetailModal('<%=obj.getEmployee().getE_name() %>','<%=obj.getTopCategory().getTop_name() %>','<%=obj.getSubCategory().getSub_name() %>','<%=obj.getReq_date() %>','<%=obj.getReq_note() %>')">
						...
						<nav aria-label="Page navigation">
							<ul class="pagination justify-content-center">
								<li class="page-item"><a class="page-link" href="/admin//dayoff/list"
								...
								<tr>
									<td colspan="9" style="text-align:center">
										...
										<a class="page-link" href="/admin//dayoff/list?currentPage=<%=i%>"><%=i %></a></li>
										<%} %>
									</td>
								</tr>
